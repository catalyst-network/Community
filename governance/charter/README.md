 ...
 * A _working group_ is a group of maintainers that is formed to take responsibility for certain aspects of the Catalyst project. Normally these groups will meet regularly but in some cases will only meet as required to fulfill their responsibilities.
...
|:---------------|:------|-------------|
| Technical | [wg-technical](../wg-technical) | Handles technical aspects of Catalyst |
| Community      | [wg-community](../wg-community/) | Handles Code of Conduct issues |
| Ecosystem      | [wg-economy](../wg-economy/) | Works on the Catalyst Economy |
